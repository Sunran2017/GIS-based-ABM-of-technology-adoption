...
/**
 * Creates an Exponential Power RSDistribution.
 *
 * @author Nick Collier
 */
public class ExponentialPowDistributionCreator extends AbstractDistributionCreator {
  ...
  public RSDistribution createRSDistribution(RandomEngine generator, Map<String, String> params) {
    double tau = doubleValue("tau", params);
    return new SimpleDistribution(strValue("name", params), new ExponentialPower(tau, generator));
  }
